...
if decision1 == 1:
    ...
    if decision2 == 1:
        print('You enter a room with test tubes and other lab equipment and looks like something from the future. do you investigate the [LAB] further or [LEAVE] the room to the previous room')
